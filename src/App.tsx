...
export default function App() {
  const features: Feature[] = [
    {
      icon: (
        <svg className="w-10 h-10 mb-6 text-artisan-green mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const testimonials: Testimonial[] = [
    {
      text: "Semenjak ganti pake mie dari sini, pelanggan pada muji mienya lebih kenyal dan gak gampang lembek. Omzet naik alhamdulillah.",
      name: "Mas Budi",
      toko: "Mie Ayam Baros",
    },
    {
      text: "Pengiriman selalu tepat waktu tiap subuh. Kualitas stabil banget, gak pernah ngecewain selama 2 tahun langganan.",
      name: "Pak Asep",
      toko: "Mie Yamin Sentral",
    },
    {
      text: "Seneng banget nemu pabrik yang bisa request ukuran mie lebar. Pas banget buat menu andalan resto kami.",
      name: "Ibu Yani",
      toko: "Resto Chinese Food",
    },
  ];
    ...
    <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden bg-artisan-krem text-artisan-slate font-sans selection:bg-artisan-green selection:text-white">
      ...
      <section id="beranda" className="container mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center gap-16 relative z-10">
        ...
        <div className="md:w-1/2 relative w-full">
          ...
          <div className="relative w-full aspect-[4/3] bg-white rounded-[2.5rem] overflow-hidden shadow-2xl border-[6px] border-white flex flex-col items-center justify-center text-artisan-slate/30">
            {/* ✏️ Ganti dengan <img src="..." /> setelah foto tersedia */}
            <svg className="w-16 h-16 mb-4 text-artisan-green/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
            </svg>
            <span className="font-medium text-sm tracking-widest uppercase">Foto Produk</span>
          </div>
          <div className="absolute -bottom-6 -left-8 bg-white p-4 shadow-xl rounded-2xl border border-gray-100 flex items-center gap-4 hover:scale-110 transition-transform duration-300 cursor-default">
            <div className="w-12 h-12 bg-artisan-krem rounded-full flex items-center justify-center">
              <svg className="w-6 h-6 text-artisan-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="produk" className="container mx-auto px-6 py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((p: Product, index: number) => (
            <div
              key={p.id}
              className="group flex flex-col bg-white rounded-3xl border border-artisan-brown/10 p-4 shadow-sm hover:shadow-2xl hover:shadow-artisan-green/10 hover:-translate-y-2 transition-all duration-500 cursor-pointer"
            ...
            >
              <div className="aspect-[4/3] rounded-2xl bg-artisan-krem flex items-center justify-center relative overflow-hidden text-artisan-green/40 mb-4">
                <svg className="w-20 h-20 group-hover:scale-110 transition-transform duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m14 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m14 0H4" />
                </svg>
                {p.badge && (
              ...
              <div className="flex flex-col flex-grow px-2">
                ...
                <p className="text-artisan-green font-bold text-xl mb-3">
                  {p.harga}<span className="text-sm font-normal text-artisan-slate/60">/kg</span>
                </p>
      ...
      <section className="px-4 py-20 md:px-10 lg:px-20 flex justify-center bg-artisan-brown text-white relative overflow-hidden" id="pricing">
        <div className="w-full max-w-[1200px] flex flex-col lg:flex-row gap-16 items-center relative z-10">
          <div className="flex flex-col gap-6 flex-1">
            ...
            <h2 className="font-serif text-5xl font-bold leading-tight">Makin Banyak,<br />Makin Untung!</h2>
            ...
            <ul className="flex flex-col gap-4 mt-4">
              {["Prioritas produksi setiap hari", "Konsistensi rasa dan tekstur terjamin", "Bisa request ukuran/ketebalan khusus (Min. 20kg)"].map((text: string, i: number) => (
                <li key={i} className="flex items-center gap-4">
                  <svg className="w-6 h-6 text-artisan-green bg-white rounded-full p-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex-1 w-full bg-white text-artisan-slate rounded-3xl shadow-2xl p-8 lg:p-10">
            ...
            <div className="flex flex-col divide-y divide-artisan-brown/10">
              {[
                { label: "Eceran / Trial", min: "Min. Pembelian 1kg", harga: "Rp 18.000", highlight: false },
                { label: "Paket Usaha Kecil", min: "Pembelian 5 - 10kg", harga: "Rp 16.000", highlight: true },
                { label: "Paket Usaha Menengah", min: "Pembelian 11 - 30kg", harga: "Rp 14.500", highlight: false },
                { label: "Paket Partai Besar", min: "Pembelian > 50kg", harga: "Rp 13.000", highlight: false },
              ].map((row, i) => (
                <div key={i} className={`flex justify-between items-center py-5 ${row.highlight ? "bg-artisan-krem/50 -mx-10 px-10 border-l-4 border-artisan-green" : ""}`}>
                  <div>
                    <p className="font-bold text-artisan-brown text-lg">{row.label}</p>
                    <p className="text-sm text-artisan-slate/60 mt-1">{row.min}</p>
                  </div>
                  <div className="text-right flex flex-col items-end gap-1">
                    <p className={`font-bold text-xl ${row.highlight ? "text-artisan-green text-2xl" : "text-artisan-brown"}`}>
                      {row.harga}<span className="text-sm font-normal text-artisan-slate/50">/kg</span>
                    </p>
                    {row.highlight && <span className="text-[10px] font-bold text-white bg-artisan-green px-3 py-1 rounded-full shadow-sm">HEMAT</span>}
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="px-4 py-16 md:px-10 lg:px-20 flex justify-center bg-white border-b border-artisan-brown/10" id="lokasi">
        <div className="w-full max-w-[1200px] flex flex-col lg:flex-row gap-12 items-center">
          <div
            className="w-full lg:w-1/2 h-80 bg-artisan-krem rounded-3xl overflow-hidden relative border-4 border-white shadow-xl flex items-center justify-center group cursor-pointer"
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-6">
              {[
                { title: "Gratis Ongkir (Area Terdekat)", desc: "Khusus pembelian minimal 10kg untuk area dalam kota yang terjangkau kurir internal kami.", icon: "M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" },
                { title: "Jadwal Pengiriman", desc: "Pengiriman dilakukan setiap hari mulai pukul 05.00 - 09.00 pagi agar mie bisa langsung diolah.", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
                { title: "Luar Kota", desc: "Melayani pengiriman via Paxel (Sameday Delivery) dengan packaging khusus agar tetap aman.", icon: "M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" },
              ].map((item, i) => (
                <div key={i} className="flex gap-5 items-start">
                  <div className="mt-1 bg-white p-3 rounded-xl border border-artisan-brown/10 shadow-sm text-artisan-green">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={item.icon} />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-bold text-artisan-brown text-lg">{item.title}</h3>
                    <p className="text-sm text-artisan-slate/70 mt-1">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            {testimonials.map((t: Testimonial, i: number) => (
              <div key={i} className="p-8 rounded-3xl bg-white border border-artisan-brown/10 shadow-lg shadow-artisan-brown/5 relative">
                ...
                <div className="flex items-center gap-4 mt-auto">
                  <div className="w-12 h-12 rounded-full bg-artisan-krem flex items-center justify-center text-artisan-brown font-bold text-xl">
                    {t.name[0]}
                  </div>
                  <div>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-12 mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-10">
              <div className="flex flex-col gap-5">
                ...
                <a className="text-sm text-white/70 hover:text-white transition-colors" href="#beranda">Beranda</a>
                <a className="text-sm text-white/70 hover:text-white transition-colors" href="#produk">Katalog Produk</a>
              ...
              <div className="flex flex-col gap-5">
                ...
                <a className="text-sm text-white/70 hover:text-white transition-colors" href="#produk">Mie Keriting</a>
                <a className="text-sm text-white/70 hover:text-white transition-colors" href="#produk">Mie Lebar (Yamin)</a>
                <a className="text-sm text-white/70 hover:text-white transition-colors" href="#produk">Mie Karet</a>
              </div>
              <div className="flex flex-col gap-5 col-span-2 md:col-span-1">
                ...
                <div className="flex gap-3 text-sm text-white/70 items-center">
                  <svg className="w-5 h-5 text-artisan-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>+62 812-3456-7890</span>
                </div>
                <div className="flex gap-3 text-sm text-white/70 items-start">
                  <svg className="w-5 h-5 text-artisan-green shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
